...
/**
 * A base/mixin class for configuring objects for pool allocation.
 * Note: PoolAllocator must be initialized in an object file.
 * **Example**: PoolAllocator Object::allocator{8};
 */
class PoolAllocaterMixin {
